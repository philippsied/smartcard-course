...
/**
 * Simulation eines Keystore zur Speicherung eines geheimen Schlüssel. Die
 * Klasse bietet die Möglichkeit zur Verschlüsselung ohne Kenntnis über den
 * LocalKeyStore sowie ohne Herausgabe des Schlüssels.
 * <p>
 * Die Klasse ist als Singleton realisiert.
 *
 */
public enum LocalKeyStore {
    ...
    /**
     * Hartkodierter RSA-Schlüssel (2048 Bit). Der Schlüssel wurde in Java
     * erzeugt und über die Konsole ausgegeben.
     */
    ...
    /**
     * Erzeugt eine anonyme Funktion zur Verschlüsselung mit dem im Keystore
