...
public class CryptoMgrApplet extends Applet implements CryptoMgr, ExtendedLength {
	 ...
	 */ 
	private final static byte WAIT_FOR_RESPONSE = (byte)0x01;
	
	/**
	 * Die Challenge-Response-Authentifizierung wurde erfolgreich durchgefuehrt.
	 */
	private final static byte CONNECTION_ESTABLISHED = (byte)0x02;	
	...
	/**
	 * Transientes einelementiges byte-Array zur Speicherung des Verbindungsstatus
	 */
