...
/**
 * Applet fuer die Ticket- und Fahrt-Verwaltung
 *
 */
public class TicketMgrApplet extends Applet {
    ...
    final static byte INS_GET_PREV_TICKET = (byte)0x30;
     ...
     */
    final static short ERROR_PENDING_TICKET = 0x6A30;


	/* -------------------- Membervariablen ------------------------------------ */

    /**
     * Speichert aktuelles Ticket
     */
    private Ticket currentTicket;
    
    /**
     * Speichert vorhergehendes Ticket
     */
    private Ticket previousTicket;
    
    /**
     * Speichert aktuell begonnene Fahrt
     */
    private Trip start;
    ...
    private void handleStartTrip(APDU apdu, byte[] buffer) {
		...
		try {
			...
			Util.arrayCopy(buffer, (short) (ISO7816.OFFSET_CDATA + 4), tmpDeparture, (short) 0,	(short) tmpDeparture.length);
